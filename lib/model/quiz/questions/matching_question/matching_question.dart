...
import 'package:schoollearning/model/quiz/questions/matching_question/matching_question_overview_card.dart';
...
class MatchingQuestion extends Question {
  ...
  // Widget matchingQuestionContent(
  //     MatchingQuestion question, int index) {
  //   return Column(
  ...
  //       ),
  //       Divider(),
  //       _showMatchingAnswerOptions(question),
  //     ],
  //   );
  // }

  // Widget _showMatchingAnswerOptions(MatchingQuestion question) {
  //   List<Widget> answerOptionsWidgetList = List();
  //   List<Widget> questionOptionsWidgetList = List();
  //
  //   List<String> shuffledAnswerOptions = question.options;
  //   shuffledAnswerOptions.shuffle();
  //
  //   List<String> shuffledQuestionOptions = question.questionOptions;
  //   shuffledQuestionOptions.shuffle();
  //
  //   for (int i = 0; i < shuffledAnswerOptions.length; i++) {
  //     answerOptionsWidgetList.add(QuestionUi.questionAnswerOption(
  //         i, shuffledAnswerOptions[i], false));
  //   }
  //   for (int i = 0; i < shuffledQuestionOptions.length; i++) {
  //     questionOptionsWidgetList.add(QuestionUi.questionAnswerOption(
  //         i, shuffledQuestionOptions[i], true));
  //   }
  //
  //   return Row(
  //     mainAxisAlignment: MainAxisAlignment.spaceAround,
  //     children: <Widget>[
  //       Column(children: questionOptionsWidgetList),
  //       Column(children: answerOptionsWidgetList),
  //     ],
  //   );
  // }
